...
dag = DAG(
	'shein_scraper',
	description='Shein Scraper DAG',
	schedule_interval=Variable.get("shein_schedule_interval", default_var = "@hourly"),
...
scrapping = PythonOperator(
	...
	python_callable=main,
 	op_kwargs={'retailer_type': str(RETAIL_TYPES['shein']), 'prefix_url': 'https://m.shein.com/'},
 	dag = dag
)

...
dag = DAG(
	'rei_scraper',
	description='REI Scraper DAG',
	schedule_interval=Variable.get("rei_schedule_interval", default_var = "@hourly"),
...
scrapping = PythonOperator(
	...
	python_callable=main,
 	op_kwargs={'retailer_type': str(RETAIL_TYPES['rei']), 'prefix_url': 'https://www.rei.com/'},
 	dag = dag
)

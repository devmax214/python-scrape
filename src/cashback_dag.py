...
dag = DAG(
	'cashback_scraper',
	description='Cashback Scraper DAG',
	schedule_interval=Variable.get("cashback_schedule_interval", default_var = "@hourly"),
...
scrapping = PythonOperator(
	...
	python_callable=main,
 	op_kwargs={'retailer_type': "-1", 'prefix_url': 'https://www.rakuten.com/'},
 	dag = dag
)
